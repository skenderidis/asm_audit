					...
					<form class="form-horizontal form-label-left" novalidate="" action="audit.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-6">
                            <label style="margin-top:5px">
                              <input type="checkbox" class="js-switch" name="file_length" id="k_file_length"/>
                            </label>
                        </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-6">
                            <label style="margin-top:5px">
                              <input type="checkbox" class="js-switch"  name="http_only" id="k_http_only"/>
                            </label>
                        </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-6">
                            <label style="margin-top:5px">
                              <input type="checkbox" class="js-switch"  name="secure" id="k_secure"/>
                            </label>
                        </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-6">
                            <label style="margin-top:5px">
                              <input type="checkbox" class="js-switch"  name="same_site" id="k_same_site"/>
                            </label>
                        </div>
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-6">
                            <label style="margin-top:5px">
                              <input type="checkbox" class="js-switch"  name="convert" id="k_convert"/>
                            </label>
                        </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-6">
                            <label style="margin-top:5px">
                              <input type="checkbox" class="js-switch"  name="file_uploads" id="k_file_uploads"/>
                            </label>
                        </div>
