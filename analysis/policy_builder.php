...
if ($policy_builder['untrusted_loosen_hours'] !=0.5 && $policy_builder['untrusted_loosen_hours'] !=1 )
{
	$new_suggestion =  array (
...
if ((int)$policy_builder['untrusted_loosen_source'] <100)
{
	$new_suggestion =  array (
		'severity' => $viol_list['untrusted_loosen_source']['severity'],
		'section' => $viol_list['untrusted_loosen_source']['section'],
		'score' =>$viol_list['untrusted_loosen_source']['score'],
		'txt'=>$viol_list['untrusted_loosen_source']['txt']
    );
	array_push($suggestions, $new_suggestion );
}
