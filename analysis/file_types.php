...
foreach ($file_types_allowed as $var)
{
	...
	if($var['name']=="*" && $analyze_file_types == "yes")
	{
	...
	if($var['performStaging']=="Yes" && $analyze_file_type_lengths == "yes")
	{
		$new_suggestion =  array (
...
if ($file_type_disallowed_count>0 && $file_type_allowed_count>1 && $analyze_file_types == "yes")
{
	$new_suggestion =  array (
