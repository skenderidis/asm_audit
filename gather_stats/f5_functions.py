	...
	if(myResponse.ok):
		...
		for key in jData['items']:
			...
			if(response_profiles.ok):
				...
				profileName= []
				jData_profiles = json.loads(response_profiles.content)
			...
			if(response_policies.ok):
				...
				policyName = []
				jData_policies = json.loads(response_policies.content)
	...
	if(myResponse.ok):
		...
		for key in jData['items']:
			...
			if(response_members.ok):
				jData_members = json.loads(response_members.content)
